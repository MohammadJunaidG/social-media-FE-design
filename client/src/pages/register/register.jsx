      ...
      <div className="loginWrapper">
        ...
        <div className="loginRight">
          <form action="" className="loginBox">
            <input placeholder='Username' type='Usename' required className="loginInput" />
            ...
            <input placeholder='Password Again' required minLength="6" className="loginInput" />
            <button className="loginButton" type="submit">Sign Up</button>
          
            <button className="loginRegisterButton" type="submit">Login your Account</button>
          </form>
